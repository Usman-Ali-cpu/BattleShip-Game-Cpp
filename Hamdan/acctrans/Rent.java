...

{
	...
	{
		  /*
�	calculate and return the rent price based on the flat fee, 
	number of days & daily rent rate
...
�	return new Rent(this.numOfDays, this.rentDailyRate);
		  ...
		  return new Rent(description, description, this.numOfDays, this.rentDailyRate);
	  }
...
�	if any error found while loading file or parsing file data, 
	throw InvalidLoadException 
�	validate that the data is parsing properly, if not, 
