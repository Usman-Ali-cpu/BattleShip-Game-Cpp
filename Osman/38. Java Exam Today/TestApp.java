...
public class TestApp {
	...
	public static void main(String[] args) throws BrandException {
		test();

	}

	// @Test
	public static void test() throws BrandException {
		...
		System.out.println(capacity.get(1).intValue());
		...
		System.out.println(m.get("FCA001").intValue());
		...
		System.out.println("1: " + m.get("FCA001").intValue());
