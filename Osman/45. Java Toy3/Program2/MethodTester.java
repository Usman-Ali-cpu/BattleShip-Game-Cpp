 ...
 * 
 * @author
 * @version 1.0 Course : ITEC 2140 Spring 2021 Written: October 6, 2021 This
 *          class provides the driver for testing the MethodContainer class.
 *          These classes simulate CodingBat.com. You are not to modify this
 *          file. Changes need to be made in the MethodContainer class.
 * 
 */
			...
			switch (probNum) {
				case 1: {
					if (4 != methods.add(2, 2)) {
						System.out.println(
								"Your answer was not correct. You returned " + methods.add(2, 2) + " instead of 4.");
						break;
					}
					if (47 != methods.add(21, 26)) {
						System.out.println(
								"Your answer was not correct. You returned " + methods.add(21, 26) + " instead of 47.");
						break;
					}
					if (-100 != methods.add(10, -110)) {
						System.out.println("Your answer was not correct. You returned " + methods.add(10, -100)
								+ " instead of -100.");
						break;
					}
				...
				case 2: {
					if (0 != methods.subtract(2, 2)) {
						System.out.println("Your answer was not correct. You returned " + methods.subtract(2, 2)
								+ " instead of 0.");
						break;
					}
					if (5 != methods.subtract(26, 21)) {
						System.out.println("Your answer was not correct. You returned " + methods.subtract(26, 21)
								+ " instead of 5.");
						break;
					}
					if (110 != methods.subtract(10, -100)) {
						System.out.println("Your answer was not correct. You returned " + methods.subtract(10, -100)
								+ " instead of 110.");
						break;
					}
					System.out.println("You got them all right!");
				...
				case 3: {
					...
					if (!methods.firstWord("Sally got all of her problems correct.").equals("Sally")) {
						System.out.println("Your answer was not correct. You returned \""
								+ methods.firstWord("Sally got all of her problems correct.")
								+ "\" instead of \"Sally\".");
						break;
					}
					System.out.println("You got them all right!");
