...
print(statemonths)
flist = [12, 3, 4, 5, 76, 88, 39, 54, 4, 333, 445, 20]
slist = [15, 31, 4, 5, 76, 38, 99, 4, 49, 343, 445, 2]
tlist = [12, 30, 4, 52, 75, 98, 9, 4, 4, 333, 445, 20]
ulist = [12, 3, 40, 5, 76, 85, 99, 47, 4, 38, 445, 10]
...
# for stt in statemonths:
#     print(statemonths[stt])
#     eachState = statemonths[stt]
#     for est in eachState:
#         flist.append(eachState[est])
# print(eachState[est])
