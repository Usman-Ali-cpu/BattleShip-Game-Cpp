...
int main() // start main of program
{
    ...
    noMonth = -24;
    float monPayment24 = (loanAmt * monIntRate) / (1.0 - pow((1.0 + monIntRate), noMonth)); // calculate months payment

    noMonth = -36;
    float monPayment36 = (loanAmt * monIntRate) / (1.0 - pow((1.0 + monIntRate), noMonth)); // calculate months payment

    noMonth = -48;
    float monPayment48 = (loanAmt * monIntRate) / (1.0 - pow((1.0 + monIntRate), noMonth)); // calculate months payment

    noMonth = -60;
    float monPayment60 = (loanAmt * monIntRate) / (1.0 - pow((1.0 + monIntRate), noMonth)); // calculate months payment
