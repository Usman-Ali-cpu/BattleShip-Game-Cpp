...
EXERSICE-7:
The destructor given for the link-based implementation of the ADT stack calls pop . Although easy to write, this
destructor can be ineffi cient due to repeated method calls. Write another implementation for the destructor that
