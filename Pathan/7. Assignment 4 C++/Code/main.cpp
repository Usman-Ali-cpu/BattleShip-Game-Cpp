...
#include <string>
#include <cassert>
#include "PlaneFlight.cpp"
#include "FrequentFlyerAccount.cpp"
...
int main()
{
    ...
    assert(std::to_string(account.getBalance()) == "3085.000000"); // free flights reduce an account balance
    if (account.canEarnFreeFlight(285))
    {
        ...
        assert(std::to_string(sample.getMileage()) == "285.000000"); // account has been reduced for this free flight...
