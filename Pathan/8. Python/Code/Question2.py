...
def main():
    ...
    print("\n********** The highest and lowest temperature for each month in 2020 *****************")
    for i in range(1, 13):
        list_of_month = get_month_data(i)
        print("\tMinimum temperature is for month " +
              str(i) + " : " + str(get_minimum(list_of_month)))
        print("\tMaximum temperature is for month " +
              str(i) + " : " + str(get_maximum(list_of_month)) + "\n")
