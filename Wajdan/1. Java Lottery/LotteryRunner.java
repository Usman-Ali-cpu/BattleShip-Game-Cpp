...
public class LotteryRunner {
    ...
    public static void main(String[] args) {
        ...
        if (Lottery.Solution1(ticketscollection, test, 999) == false
        ...
        if (Lottery.Solution1(ticketscollection, test, 1999) == false
                && Lottery.Solution1(ticketscollection, ticketscollection[index].GetTicket(), 1999) == true)
        ...
        if (Lottery.Solution2(ticketscollection, 0, 1999, test) == false
                && Lottery.Solution2(ticketscollection, 0, 1999, ticketscollection[index].GetTicket()) == true)
            System.out.println("Solution 2 Test 2 Passed!");
        else
            System.out.println("Solution 2 Test 2 Failed!");

        System.out.println("*********************************");
        test = Lottery.GenerateRandomWinner(rn); // random ticket index =
        Lottery.GenerateSelectWinner(5000, rn); // index of a winning ticket
        ...
        if (Lottery.Solution1(ticketscollection, test, 4999) == false
                && Lottery.Solution1(ticketscollection, ticketscollection[index].GetTicket(), 4999) == true)
        ...
        if (Lottery.Solution2(ticketscollection, 0, 4999, test) == false
                && Lottery.Solution2(ticketscollection, 0, 4999, ticketscollection[index].GetTicket()) == true)
        ...
        if (Lottery.Solution1(ticketscollection, test, 8999) == false
                && Lottery.Solution1(ticketscollection, ticketscollection[index].GetTicket(), 8999) == true)
        ...
        if (Lottery.Solution2(ticketscollection, 0, 8999, test) == false
                && Lottery.Solution2(ticketscollection, 0, 8999, ticketscollection[index].GetTicket()) == true)
        ...
        if (Lottery.Solution1(ticketscollection, test, ticketscollection.length) == false && Lottery
                .Solution1(ticketscollection, ticketscollection[index].GetTicket(), ticketscollection.length) == true)
        ...
        if (Lottery.Solution2(ticketscollection, 0, ticketscollection.length, test) == false
                && Lottery.Solution2(ticketscollection, 0, ticketscollection.length,
                        ticketscollection[index].GetTicket()) == true)
